...
ClusterMarker.prototype._clusterMarker=function ($clusterGroupIndexes){
  ...
  markerId = markerId.slice(0, Drupal.settings.simpleGeoTileserviceMap.maxNodes);

  // This uses a public function defined by simplegeo_tileservice_map.js.
  $clusterMarker= simplegeoMapNewMarker('cluster', $clusterGroupBounds.getCenter(), clusterCount, $clusterGroupBounds, markerId, Drupal.t("Show items"), this._map);
